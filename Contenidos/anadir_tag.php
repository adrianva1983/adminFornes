...
print "<form action=\"/administra/Contenidos/anadir_tag_2.php\" enctype=\"multipart/form-data\" method=\"POST\">";
...
print "<li><label for=\"Sinonimos\">".$lang["sinonimos"].":</label><br/><textarea wrap=\"VIRTUAL\" class=\"form ancho100\" rows=\"3\" cols=\"60\" name=\"Sinonimos\" id=\"Sinonimos\"></textarea></li>";
print "<li><label for=\"URL\">".$lang["url"].":</label><br/><input name=\"URL\" type=\"text\" value=\"\" size=\"100\" maxlength=\"200\"></li>";
print "<li><label for=\"Imagen\">".$lang["imagen"].": </label><input id=\"Imagen\" name=\"Imagen\" type=\"file\">";
print "</ul>";
