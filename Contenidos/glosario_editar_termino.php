...
print "});";
print "</script>";
print "<form action=\"/administra/Contenidos/glosario_editar_termino_2.php\" enctype=\"multipart/form-data\" method=\"POST\">";
require($_SERVER['DOCUMENT_ROOT']."/administra/Interface/conexion.php");
$requete = "SELECT * FROM `Glosario` WHERE `Id`=".$id;

$listado = mysqli_fetch_object($result);
print "<ul>";
print "<li><label for=\"Termino\">".$lang["termino"].": </label><input id=\"Termino\" name=\"Termino\" type=\"text\" value=\"".$listado->Termino."\" size=\"50\" maxlength=\"255\"></li>";
print "<li><label for=\"Descripcion\">".$lang["descripcion"].": </label><textarea id=\"Descripcion\" name=\"Descripcion\" cols=\"60\" rows=\"10\" class=\"form\" wrap=\"VIRTUAL\">".$listado->Descripcion."</textarea></li>";
print "<li><label for=\"Url\">".$lang["enlace"].": </label><input id=\"Url\" name=\"Url\" type=\"text\" value=\"".$listado->Url."\" size=\"50\" maxlength=\"255\"></li>";
print "</ul>";
