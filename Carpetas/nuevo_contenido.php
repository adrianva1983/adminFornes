...
$javascript_onready .= "
		...
		";
print '<div class="row"><div class="col-lg-12"><div class="ibox float-e-margins"><div class="ibox-title"><h5>'.$lang['titulo_nuevo_contenido'].'</h5><div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div><div class="ibox-content">';
print "<form id=\"formulario_nuevo_contenido\" action=\"/administra/Carpetas/nuevo_contenido_2.php\" enctype=\"multipart/form-data\" method=\"POST\" class=\"form-horizontal\">";
...
print "<div class='form-group'><label class='col-sm-2 control-label' for=\"Breve\">".$lang["breve"]."</label><div class='col-sm-10'><textarea id=\"Breve\" name=\"Breve\" cols=\"60\" rows=\"10\" class=\"form\" wrap=\"VIRTUAL\"></textarea></div></div>";
print "<div class='form-group'><label class='col-sm-2 control-label' for=\"Fecha\">".$lang["fecha"]."</label><div class='col-sm-10'><input class='form-control' id=\"Fecha\" name=\"Fecha\" type=\"text\" value=\"\" size=\"10\" maxlength=\"10\"></div></div>";
...
print "<div class='form-group'><label class='col-sm-2 control-label' for=\"Redireccionar\">".$lang["redireccionar"]."</label><div class='col-sm-7'><input class='form-control' id=\"Redireccionar\" name=\"Redireccionar\" type=\"text\" value=\"\" size=\"50\" maxlength=\"255\"></div>";
print "<div class='col-sm-3'><div class='i-checks'><label><input id=\"RedireccionarAparte\" name=\"RedireccionarAparte\" type=\"checkbox\" value=\"1\"><i></i> ".$lang["ventanaAparte"]."</label></div></div></div>";

print "<div id=\"buscadores\"><div class=\"hr-line-dashed\"></div>";
print "<div class='form-group'><label class='col-sm-2 control-label' for=\"TituloBuscadores\">".$lang["tituloBuscadores"]."</label><div class='col-sm-10'><textarea id=\"TituloBuscadores\" name=\"TituloBuscadores\" cols=\"60\" rows=\"3\" class=\"form contador_SEOTit\" wrap=\"VIRTUAL\"></textarea><div id=\"longitud_contador_SEOTit\"></div></div></div>";
print "<div class='form-group'><label class='col-sm-2 control-label' for=\"DescripcionBuscadores\">".$lang["descripcionBuscadores"]."</label><div class='col-sm-10'><textarea id=\"DescripcionBuscadores\" name=\"DescripcionBuscadores\" cols=\"60\" rows=\"10\" class=\"form contador_SEODesc\" wrap=\"VIRTUAL\"></textarea><div id=\"longitud_contador_SEODesc\"></div></div></div>";
print "<div class='form-group'><label class='col-sm-2 control-label' for=\"URLAmigable\">".$lang["urlamigable"]."</label><div class='col-sm-10'><input class=\"form-control\" id=\"URLAmigable\" name=\"URLAmigable\" type=\"text\" value=\"\" size=\"50\" maxlength=\"255\"></div></div>";
print "<div class='form-group'><label class='col-sm-2 control-label' for=\"Keywords\">".$lang["keywords"]."</label><div class='col-sm-10'><textarea id=\"Keywords\" name=\"Keywords\" cols=\"60\" rows=\"3\" class=\"form contador_SEOKey\" wrap=\"VIRTUAL\"></textarea><div id=\"longitud_contador_SEOKey\"></div></div></div>";
print "</div>";
...
print "<div class='form-group'><label class='col-sm-2 control-label' for=\"Notas\">".$lang["notas"]."</label><div class='col-sm-10'><textarea id=\"Notas\" name=\"Notas\" cols=\"60\" rows=\"10\" wrap=\"VIRTUAL\"></textarea></div></div>";
print "<div class='form-group'><label class='col-sm-2 control-label' for=\"Comportamiento\">".$lang["comportamiento"]."</label><div class='col-sm-10'><div class='i-checks'><label><input type=\"radio\" value=\"Plantilla\" name=\"Comportamiento\" checked/><i></i> ".$lang["pulsarYPlantilla"]."</label></div>";
print "<div class='i-checks'><label><input type=\"radio\" value=\"EmergenteImagen\" name=\"Comportamiento\"/><i></i> ".$lang["pulsarYImagen"]."</label></div>";
print "<div class='i-checks'><label><input type=\"radio\" value=\"EmergenteEnlace\" name=\"Comportamiento\"/><i></i> ".$lang["pulsarYEnlace"]."</label></div>";
print "<div class='i-checks'><label><input type=\"radio\" value=\"EmergenteContenido\" name=\"Comportamiento\"/><i></i> ".$lang["pulsarYContenido"]."</label></div>";
print "<div class='i-checks'><label><input type=\"radio\" value=\"noPinchable\" name=\"Comportamiento\"/><i></i> ".$lang["noPulsable"]."</label></div></div></div>";
...
print "<div class='form-group'><label class='col-sm-2 control-label' for=\"TipoContenido\">".$lang["tipo"]."</label><div class='col-sm-10'><select class=\"form-control\" id=\"TipoContenido\" name=\"TipoContenido\">";
...
if (($result) && (mysqli_num_rows($result)>0))
{
	while($listado = mysqli_fetch_object($result))
	{
		print "<option value=\"".$listado->Id."\">".$listado->Tipo."</option>";
	}
}
print "</select></div></div>";
