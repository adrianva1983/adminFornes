...
//Cargamos el contenido en la base de datos
	$requete = "UPDATE `Contenidos` SET `Titulo` = '".$Titulo."', `Breve` ='".$Breve."', `Keywords` = '".$Keywords."', `NomFich` = '".$NomFich."', `PrecioBI` = '".$PrecioBI."', `PrecioTAX` = '".$PrecioTAX."'";
	$requete.=",`FechaModificacion`='".date("Y-m-d h:i:s")."',`TituloBuscadores`='".$TituloBuscadores."',`DescripcionBuscadores`='".$DescripcionBuscadores."',`URLAmigable`='".$URLAmigable."'";
