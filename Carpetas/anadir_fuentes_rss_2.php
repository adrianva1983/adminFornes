...
$requete = "INSERT INTO `Contenidos` (`Fecha`,`FechaComienzo`, `Titulo`, `Breve`, `Redireccionar`, `Tipo`";
$requete .= ", `Idioma`";
$requete .= ") VALUES ('".date("Y-m-d")."', '".date("Y-m-d")."', '".$Titulo."', 'Modo:".$Modo."/Ampliable:".$Ampliable."/Estado:".$estado."/syncMax:".$syncMax."', '".$Fuente."', 'rss'";
