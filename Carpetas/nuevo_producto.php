...
print "});";
print "</script>";
print "<form action=\"/administra/Carpetas/nuevo_producto_2.php\" enctype=\"multipart/form-data\" method=\"POST\">";
print "<ul>";
print "<li><label for=\"Titulo\">".$lang["titulo"].": </label><input id=\"Titulo\" name=\"Titulo\" type=\"text\" value=\"\" size=\"50\" maxlength=\"255\"></li>";
print "<li><label for=\"Breve\">".$lang["breve"].": </label><textarea id=\"Breve\" name=\"Breve\" cols=\"60\" rows=\"10\" class=\"form\" wrap=\"VIRTUAL\"></textarea></li>";
print "<li><label for=\"Fecha\">".$lang["fecha"].": </label><input id=\"Fecha\" name=\"Fecha\" type=\"text\" value=\"\" size=\"10\" maxlength=\"10\"></li>";
print "<li><label for=\"Foto\">".$lang["imagen"].": </label><input id=\"Foto\" name=\"Foto\" type=\"file\"></li>";
print "<li><label for=\"Icono\">".$lang["icono"].": </label><input id=\"Icono\" name=\"Icono\" type=\"file\"></li>";
print "<li><label for=\"PrecioBI\">".$lang["precioBI"].": </label> <input id=\"PrecioBI\" name=\"PrecioBI\" type=\"text\" value=\"0\" size=\"8\" maxlength=\"6\">";
print " <label for=\"PrecioTAX\">".$lang["precioTAX"].": </label> <input id=\"PrecioTAX\" name=\"PrecioTAX\" type=\"text\" value=\"21\" size=\"8\" maxlength=\"6\">";
print " <label for=\"PrecioFinal\">".$lang["precioFinal"].": </label> <input id=\"PrecioFinal\" name=\"PrecioFinal\" type=\"text\" value=\"0\" size=\"8\" maxlength=\"6\"></li>";
print "</ul>";
...
print "<li><label for=\"TituloBuscadores\">".$lang["tituloBuscadores"].": </label><textarea id=\"TituloBuscadores\" name=\"TituloBuscadores\" cols=\"60\" rows=\"3\" class=\"form contador_SEOTit\" wrap=\"VIRTUAL\"></textarea><div id=\"longitud_contador_SEOTit\"></div></li>";
print "<li><label for=\"DescripcionBuscadores\">".$lang["descripcionBuscadores"].": </label><textarea id=\"DescripcionBuscadores\" name=\"DescripcionBuscadores\" cols=\"60\" rows=\"10\" class=\"form contador_SEODesc\" wrap=\"VIRTUAL\"></textarea><div id=\"longitud_contador_SEODesc\"></div></li>";
...
print "<li><label for=\"Keywords\">".$lang["keywords"].": </label><textarea id=\"Keywords\" name=\"Keywords\" cols=\"60\" rows=\"3\" class=\"form contador_SEOKey\" wrap=\"VIRTUAL\"></textarea><div id=\"longitud_contador_SEOKey\"></div></li>";
print "</ul>";
...
print "<li><label for=\"Notas\">".$lang["notas"].": </label><textarea id=\"Notas\" name=\"Notas\" cols=\"60\" rows=\"10\" wrap=\"VIRTUAL\"></textarea></li>";
