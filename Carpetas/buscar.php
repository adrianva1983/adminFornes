...
// El listado mostrará el Título de la sección y un enlace a la herramienta secciones con el parámetro de la sección y la ruta de donde está.
...
//Cargamos el idioma
require($_SERVER['DOCUMENT_ROOT']."/administra/Carpetas/idiomas/buscar-".$_SESSION['idioma'].".conf");
print '
