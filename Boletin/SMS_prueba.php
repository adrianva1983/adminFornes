...
if ($result = mysqli_query($db, $requete))
{
	...
	$Destinatario = $listado->MovilPruebas;
}
...
else
{
	...
	require("http://www.sepomo.com/clientes/send_sms.php?number=%2B34".$Destinatario."&message=".$Texto."&id_client=AABSK&password=medidieta");
	print "<br/>";
...
print "</p>";
print "<p><a href=\"/administra/Interface/herramienta.php?modulo=Boletin&herramienta=SMSVer&idSMS=".$idSMS."\">Volver a los datos del SMS Marketing</a></p>";
?>