...
//Cargamos el idioma
require($_SERVER['DOCUMENT_ROOT']."/administra/Boletin/idiomas/nuevo_usuario_SMS-".$_SESSION['idioma'].".conf");
...
print "<input name=\"idSMS\" type=\"hidden\" value=\"".$idSMS."\">";
...
if ($busca!="")
{
 print "<form name=\"fbusca\" action=\"/administra/Boletin/nuevo_usuario_SMS_3.php\">";
 print "<input name=\"idSMS\" type=\"hidden\" value=\"".$idSMS."\">";
 include "nuevo_usuario_SMS_2.php";
